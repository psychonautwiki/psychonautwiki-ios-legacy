...
class MasterViewController: UITableViewController {
    ...
    var detailViewController: SubstanceDetailViewController? = nil
    var objects = [Any]()
    ...
    override func viewDidLoad() {
        ...
        if let split = self.splitViewController {
            ...
            self.detailViewController = (controllers[controllers.count-1] as! UINavigationController).topViewController as? SubstanceDetailViewController
        }
    }
